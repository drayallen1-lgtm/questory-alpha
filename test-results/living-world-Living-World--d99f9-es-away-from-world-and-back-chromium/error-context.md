...
- Name: living-world.spec.js >> Living World (map-first) >> floating dock navigates away from world and back
- Location: tests\e2e\living-world.spec.js:22:7

# Error details

```
Error: App root not visible after primeAppState reload. page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:5173/
Call log:
