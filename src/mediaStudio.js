...
export const HORROR_ASSET_LIBRARY = {
  ...
  objects: [
    ...
    { id: 'portal-ufo', title: 'UFO', type: 'image', icon: '🛸', category: 'objects', offline: true, previewUrl: HORROR_IMAGES.ufo, assetUrl: HORROR_IMAGES.ufo },
    { id: 'relic-dragon-egg', title: 'Dragon Egg', type: 'image', icon: '🥚', category: 'objects', offline: true, previewUrl: HORROR_IMAGES.dragonEgg, assetUrl: HORROR_IMAGES.dragonEgg, safeForKids: true },
    { id: 'relic-phoenix-feather', title: 'Phoenix Feather', type: 'image', icon: '🪶', category: 'objects', offline: true, previewUrl: HORROR_IMAGES.phoenixFeather, assetUrl: HORROR_IMAGES.phoenixFeather },
