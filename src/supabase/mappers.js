...
export function rowToAdventure(row, clues = []) {
  ...
  return normalizeAdventure({
    ...
    accessType: row.access_type || 'hybrid',
    playRadiusM: row.play_radius_m ?? null,
...
export function adventureToRow(adventure, creatorId) {
  ...
  return {
    ...
    access_type: adventure.accessType || 'hybrid',
    play_radius_m: adventure.playRadiusM ?? null,
